...
def totaltext_classes():
    """totaltext class names for external use."""
    return ['Backgroud', 'Character']
...
def totaltext_palette():
    """Totaltext palette for external use."""
...
dataset_aliases = {
    ...
    'isaid': ['isaid', 'iSAID'],
    'stare': ['stare', 'STARE'],
    'totaltext': ['totaltext', 'Totaltext','TotalText'],
}
